...
class RS_Camera: #real sense camera
    ...
    def take_picture(self):
        ...
        while count == 0 :
            ...
            self.depth_filename=os.path.join(self.intelImages,f"depth_{filename_sub}.png")
    ...
    def object_detection(self,fileName):
        ...
        subprocess.Popen("~/AstroCultivatorNew/AstroCultivators/yolov7-custom","python", "detect.py", 
                         "--weights yolov7_custom.pt --conf 0.5 --img-size 640 --source", fileName," --view-img --no-trace --save-txt")
